...
import AllergyTypeRow from "./AllergyTypeRow"
import React, { useState, useEffect, useRef, useMemo, Fragment } from 'react'
import { Sort_by } from "../../../../../../../_helper/objectSorter"
import Pagination from "../../../../../../../_helper/paginationHook/Pagination"

const TypesData = [
    { formID: 1, name: "Adverse Allergy", dateCreated: '2021-05-30' },
    { formID: 2, name: "Animal Allergy", dateCreated: '2020-09-01' },
    { formID: 3, name: "Drug Allergy", dateCreated: '2020-10-08' },
    { formID: 4, name: "Enviroment Allergy", dateCreated: '2023-01-01' },
    { formID: 5, name: "Food Allergy", dateCreated: '2023-01-01' },
    { formID: 6, name: "Miscellaneous Allergy", dateCreated: '2023-01-02' },
    { formID: 9, name: "Plant Allergy", dateCreated: '2021-06-08' },
    { formID: 10, name: "Polen Allergy", dateCreated: '2021-07-26' }
]

const AllergyTypeTable = () => {
    ...
    return (
        <div>
            <div className='fv-row mb-7 fv-plugins-icon-container'>
                {
                    newTypeForm ? <AllergyTypeForm setNewTypeForm={setNewTypeForm} AddType={AddType}
                    />
                        :
                        <div>
                            <div className="d-flex justify-content-between">
                                <h4 className='mb-5'>Allergy Types</h4>
                                <div>
                                    <button className="btn btn-primary btn-sm" onClick={() => {
                                        setNewTypeForm(true)
                                    }}>Add New Allergy Type</button>
                                </div>
                            </div>
                                            ...
                                            <div>
                                                <div className='d-flex align-items-center position-relative overflow-auto my-1'>
                                                    ...
                                                    <input
                                                        ...
                                                        placeholder='Search Allergy Types'
                                                    />
                                                </div>
                                            </div>
                                        ...
                                        >
                                            ...
                                            <tbody>
                                                {SharedTypes.length > 0 ? SharedTypes.map((type, index) => (
                                                    <Fragment key={index}>
                                                        <AllergyTypeRow type={type} setDeleteType={setDeleteType}/>
                                                    </Fragment>
                                                )) :
                                                    <tr>
                                ...
                                <div className="modal-dialog modal-dialog-centered mw-600px mh-100px">
                                    ...
                                    <div className="modal-content">
                                        ...
                                        <div className="modal-header d-flex justify-content-center">
                                            {/*begin::Modal title*/}
                                            <h2 className="fw-bolder">ARE YOU SURE YOU WANT TO DELETE THIS ALLERGY TYPE?</h2>
                                            {/*end::Modal title*/}
                                        </div>
                                        {/*end::Modal header*/}
                                        {/*begin::Modal body*/}
...
export default AllergyTypeTable