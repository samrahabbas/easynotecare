...
import ContactNewFormRow from './ContactNewTableRow'
                ...
                <div className='post d-flex flex-column-fluid' id='kt_post'>
                    <div id='kt_content_container' className='container-xxl'>
                        <div className='card-header border-0 pt-6'>
                            <h1 className='mt-5 mb-2'>Create New Contact</h1>
                            <div className='w-100'>
                            ...
                            >
                                ...
                                <tbody>
                                    {IndividualPaginationData.length > 0 ? IndividualPaginationData.map((individual, index) => (
                                        <Fragment key={index}>
                                            <ContactNewFormRow individual={individual} />
                                        </Fragment>
                                    )) :
                                        <tr>
...
export default ContactNewFormTable