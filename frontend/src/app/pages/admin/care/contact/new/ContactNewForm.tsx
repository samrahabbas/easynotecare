...
const registrationSchema = Yup.object().shape({
    ...
    relaiontoind: Yup.string()
        .min(3, 'Minimum 3 symbols')
        .max(50, 'Maximum 50 symbols')
        .required('Relation to individual is required'),
...
const ContactNew: React.FC<ContactNewProps> = ({ setShowNewForm, setShowEditingForm, clientInfo }) => {
            ...
            <div className='fv-row mb-7 fv-plugins-icon-container p-5 card'>
                <div className=' card-title'>
                    <div className='row d-flex'>
                        ...
                        <div className=' col '>
                            <Link to={'/care/contact/new'} className='btn btn-light btn-active-primary float-end'>
                                Clients
                            </Link>
                        </div>
                    </div>
                ...
                <Formik
                    initialValues={{
                        individualID: clientInfo.formID,
                        firstName: '',
                        lastName: '',
                        agency: '',
                        relaiontoind: '',
                    ...
                    onSubmit={(values, { setSubmitting }) => {
                        let tempObj: any = {}
                        tempObj = values
                        if (showMailAddress === false && showAddress === true) {
                            tempObj.mailingInfo['st1'] = values.addressInfo.st1
                            tempObj.mailingInfo['st2'] = values.addressInfo.st2
                            tempObj.mailingInfo['city'] = values.addressInfo.city
                            tempObj.mailingInfo['state'] = values.addressInfo.state
                            tempObj.mailingInfo['zipCode'] = values.addressInfo.zipCode
                            tempObj.mailingInfo['country'] = values.addressInfo.country
                            tempObj.mailingInfo['primaryPhone'] = values.addressInfo.primaryPhone
                            tempObj.mailingInfo['secondaryPhone'] = values.addressInfo.secondaryPhone
                            tempObj.mailingInfo['additionalPhone'] = values.addressInfo.additionalPhone
                            tempObj.residentialAddr = true
                            tempObj.mailingAddr = true
                        }
                        if (showMailAddress === false && showAddress === false) {
                            ...
                            tempObj.addressInfo['st1'] = ''
                            tempObj.addressInfo['st2'] = ''
                            tempObj.addressInfo['city'] = ''
                            tempObj.addressInfo['state'] = ''
                            tempObj.addressInfo['zipCode'] = ''
                            tempObj.addressInfo['country'] = ''
                            tempObj.addressInfo['primaryPhone'] = ''
                            tempObj.addressInfo['secondaryPhone'] = ''
                            tempObj.addressInfo['additionalPhone'] = ''
                        ...
                        console.log(tempObj)
                        axios.post('/contacts/create', tempObj)
                            .then(res => {
                                        ...
                                        <div className='row'>
                                            ...
                                            <div className='col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12 my-3'>
                                                ...
                                                <Field
                                                    className='form-control form-control-solid mb-3 mb-lg-0'
                                                    type='number'
                                                    name='addressInfo.secondaryPhone'
                                                    autoComplete='off'
                                                />
                                            </div>
                                        </div>
                                        ...
                                        <div className='row'>
                                            <div className='col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12 my-3'>
                                                ...
                                                <Field
                                                    className='form-control form-control-solid mb-3 mb-lg-0'
                                                    type='number'
                                                    name='addressInfo.additionalPhone'
                                                    autoComplete='off'
                                                />
                                            </div>
