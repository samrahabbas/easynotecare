...
import ListOfTlogRow from './ListOfTlogRow'
...
import ListOfTlogsEdit from './ListOfTlogsEdit'
    ...
    useEffect(() => {
        axios.all([
            ...
            .then(axios.spread((clients, tlogs) => {
                ...
                setTlogs(tempDataTlog)
                setTlogStatic(tempDataTlog)
            }))
    }, [showForm])
    ...
    return (
        <div>
            <div className='card mb-5 col-mb-10' id='kt_content'>
                {
                    showForm ? <ListOfTlogsEdit selectedLog={selectedLog} setShowForm={setShowForm} />
                        :
                        <div className='post d-flex flex-column-fluid' id='kt_post'>
                            <div id='kt_content_container' className='container-xxl'>
                                <div className='card-header border-0 pt-6'>
                                    <h1 className='mt-5'>Tlogs List</h1>
                                    <div className='w-100'>
                                    ...
                                    >
                                        ...
                                        <tbody>
                                            {TlogPaginationData.length > 0 ? TlogPaginationData.map((log, index) => (
                                                <Fragment key={index}>
                                                    <ListOfTlogRow log={log} setSelectedLog={setSelectedLog} setShowForm={setShowForm} setDeleteTlogID={setDeleteTlogID} />
                                                </Fragment>
                                            )) :
                                                <tr>
