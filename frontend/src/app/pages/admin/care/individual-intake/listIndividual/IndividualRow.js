...
const IndividualRow = ({ individual, setEditIndividualData, setDeleteIndividualId, setShowResAddr, setShowMailingAddr, setShowEditForm }) => {
    return (
        <tr>
            <td className="px-3">
                <Link to={{
            ...
            <td className="text-gray-800 mb-1">
                ...
                <button data-bs-toggle="modal" data-bs-target="#kt_modal_delete_individual"
                    ...
                    onClick={() => setDeleteIndividualId(individual.formID)}
                >
                    <span className='svg-icon svg-icon-3'>
                        <svg
                            xmlns='http://www.w3.org/2000/svg'
