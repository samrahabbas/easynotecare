...
import { updateBehavior } from '../../behavior-antecedent-intervention-categories/store/actions';
...
const IEditing = ({ setEditEntryDataI, setShowEditingFormI, editEntryDataI, updateIntervention }) => {
          ...
          <div className="d-flex w-100">
            <div className="card-header w-75">
              <div className="card-title">
                <h3 className="fw-bolder">Form for editing: {editEntryDataI.name}</h3>
              </div>
            </div>
          </div>
          <Formik
            initialValues={editEntryDataI}
            validationSchema={registrationSchema}
            onSubmit={(values, { setSubmitting }) => {
              // updateIntervention(values)
              dispatch(updateBehavior(values))
              setShowEditingFormI(true)
              setEditEntryDataI('')
            }}>
                  ...
                  <div className="row">
                    ...
                    <div className="d-flex w-100">
                      <div className='w-50'>
                        ...
                        <label className="fw-bold fs-4 mb-2 w-100">Interventation</label>
                      </div>
                      <div className='w-50'>
