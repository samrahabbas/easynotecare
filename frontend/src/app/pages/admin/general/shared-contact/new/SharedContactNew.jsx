...
const registrationSchema = Yup.object().shape({
    ...
    type: Yup.string()
        .required('Shared Contact Type is required'),
    email: Yup.string()
        ...
        <div>
            <Formik
                ...
                onSubmit={(values) => {
                    ...
                    axios.post("/shared/create", tempObj)
                        .then(res => {
                            history.push("/general/shared-contact/list")
                        })
                }}
            >
                <Form>
                    <div className='fv-row mb-7 fv-plugins-icon-container p-5 card'>
                        <div className='card-body'>
                            ...
                            <div className='d-flex justify-content-end'>
                                <div>
                                    <button className='btn btn-primary mt-4 me-4' onClick={() => {
                                        history.push("/general/shared-contact/list")
                                    }}>Cancel</button>
