const SharedContactListRow = ({ contact, setEditSharedContact, setDeleteSharedContact, setShowEditForm }) => {
    return (
        <tr>
            <td className="px-3">
...
export default SharedContactListRow